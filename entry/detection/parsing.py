...
def main():
    csv_file = pd.read_csv(
            '/data2/chest_xray/siim-covid19-detection/train_image_level.csv'
    )
    ...
    json_file = json.load(
            open('/data2/chest_xray/siim-covid19-detection/entry/fold.json')
    )
    ...
    with open('/work/Lung/SIIM/train_list.txt', 'w') as f:
        f.writelines(train_ls)
    with open('/work/Lung/SIIM/valid_list.txt', 'w') as f:
